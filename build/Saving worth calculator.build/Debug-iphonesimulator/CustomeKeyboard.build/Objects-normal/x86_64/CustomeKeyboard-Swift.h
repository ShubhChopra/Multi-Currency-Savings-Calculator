...
SWIFT_MODULE_NAMESPACE_PUSH("CustomeKeyboard")
@class UIView;
@protocol UITextInput;
@class NSBundle;
@class NSCoder;

SWIFT_CLASS("_TtC15CustomeKeyboard22KeyboardViewController")
@interface KeyboardViewController : UIInputViewController
@property (nonatomic, strong) UIView * _Null_unspecified NumberPadView;
